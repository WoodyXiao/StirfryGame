...
/*Pork class that extending from the Meat, using the same methods 
including checkMeatHit, drawMeat, etc.. */
public class Pork extends Meat {
	private PVector location;
	protected BufferedImage img;

	public Pork(double x, double y) {
		location = new PVector((float) x, (float) y);
		img = ImageLoader.loadImage("assets/pork.png");
	}
	...
	public boolean checkPorkHit(MouseEvent e) {
	...
	public boolean checkPorkHitPan(Pan p) {
