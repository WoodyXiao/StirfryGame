...
public class PanOilPorkVegNoodlesSauce extends PanBasicDecorator {
	private BufferedImage img;

	public PanOilPorkVegNoodlesSauce(PanDrawingInterface panDecorator) {
		super(panDecorator);
		img = ImageLoader.loadImage("assets/panwporkwvegwnoodleswsauce.png");
	}
