...
public class PanOilChickenVeg extends PanBasicDecorator {
	private BufferedImage img;

	public PanOilChickenVeg(PanDrawingInterface panDecorator) {
		super(panDecorator);
		img = ImageLoader.loadImage("assets/panwchickenwveg.png");
	}
