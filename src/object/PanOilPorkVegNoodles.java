...
public class PanOilPorkVegNoodles extends PanBasicDecorator {
	private BufferedImage img;

	public PanOilPorkVegNoodles(PanDrawingInterface panDecorator) {
		super(panDecorator);
		img = ImageLoader.loadImage("assets/panwprokwvegwnoodles.png");
	}
