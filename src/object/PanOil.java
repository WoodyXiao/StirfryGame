...
/*here is a decorator of pan that when oil on the pan. */

public class PanOil extends PanBasicDecorator {
	private BufferedImage img;

	public PanOil(PanDrawingInterface panDecorator) {
		super(panDecorator);
		img = ImageLoader.loadImage("assets/panwoil.png");
	}
