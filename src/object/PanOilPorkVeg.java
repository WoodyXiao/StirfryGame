...
public class PanOilPorkVeg extends PanBasicDecorator {
	private BufferedImage img;

	public PanOilPorkVeg(PanDrawingInterface panDecorator) {
		super(panDecorator);
		img = ImageLoader.loadImage("assets/panwporkwveg.png");
	}
